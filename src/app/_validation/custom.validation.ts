...
export class CustomValidator {
    ...
    static matchPassword(group): any {
        ...
        //const password=group.root.controls.newPassword;
        //const confirm=group.root.controls.confirmPassword;
    ...
    // dropdown custom validatin
    static lookupRequired(ddlValue): any {
        /* if (ddlValue.pristine) {
            return null;
        } */
        ddlValue.markAsTouched();
        if (ddlValue.value != "0") {
            return null;
        }
        return {
